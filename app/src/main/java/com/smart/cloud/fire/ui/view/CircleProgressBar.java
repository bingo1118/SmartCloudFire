package com.smart.cloud.fire.ui.view;
...
public class CircleProgressBar extends View {
     ...
     * 渐变圆周颜色数组
     */
    private int[] colorArray = new int[] { Color.parseColor("#2242fe"), Color.parseColor("#2bcbff"),Color.parseColor("#f609ff")  };//
...
//                    circleWidth=35;
    ...
    private void drawCircle(Canvas canvas, int center, int radius)
    {
        ...
        canvas.drawArc(oval, 10, alphaAngle, false, circlePaint);
    }
